...
// function App() {
//   const newData= data_.length;
//   // const newData = [];
//   return (
//     <div className="m-5 bg-secondary">
//       <h1 className="fw-bold text-center text-primary p-3">STUDENT INFORMATION SYSTEM</h1>

//       <input type="text" placeholder="Search"  style={{ margin: '55px 0 0 75px',  width: '30rem', height:'40px', borderColor: 'blue',  maxWidth: '50%', padding:'10px'}}/>
//       <br/>
//       <button style={{backgroundColor: 'black', color: 'white', margin: '10px 0 0 75px', padding: '9px'}}>Find Name</button>

//       <div className="m-5 " style={{margin: 'auto', width:'100%'}}>
//         <div className="d-flex justify-content-space-between flex-wrap">
//         {/* This isn't the best practice, iternary operator can only be done in the jsx */}
//         {/* <Students image={data[0].image} name={data[0].name} words={data[0].word} level={data[0].level} />
//         <Students image={data[1].image} name={data[1].name} words={data[1].word} level={data[1].level} />
//         <Students image={data[2].image} name={data[2].name} words={data[2].word} level={data[2].level}/>
//         <Students image={data[3].image} name={data[3].name} words={data[3].word} level={data[3].level}/>
//         <Students image={data[4].image} name={data[4].name} words={data[4].word} level={data[4].level}/>
//         <Students image={data[5].image} name={data[5].name} words={data[5].word} level={data[5].level}/> */}

//        {/* {newData > 0 ? data_.map((index)=> (
//         <Students loadData={index} key={index.id}/>
//        )) : <Error/>} */}
...
function App() {
  // useState
  const [data, setData] = useState("mayowa"); //storing    string,  object, array, boolean , numbers
  ///input form
  ...
  }  // onClick  use for button's
  //onChange use for  input ,there has to be a state and a function to power the state 
  // onSubmit use for  forms
  ...
  return (
    <div>
      ...
      {/* <form onSubmit={handleSubmit} >
        <input className="form-control mt-2" onChange={handleUsername} value={username} placeholder="username" />
        <input className="form-control mt-2" onChange={handleEmail} value={email} placeholder="email" />
        <input className="form-control mt-2" placeholder="password" onChange={handlePaswword} value={password} />
        <button type="submit" className="btn btn-dark p-3 mt-4">Keep info</button>
      </form> */}
...
function Students(props) {
  return (
    <div>
      <div className="card text-center m-4  bg-transparent text-light border-light " style={{ width: "18rem" }}>
        <h3 className="card-title fs-5 p-3"> <span className="fw-bold ">Name: </span>{props.loadData.name}</h3>
        <hr />
        <div className="card-body">
          <h5 className="card-title"> <span className="fw-bold">Email: </span>{props.loadData.email}</h5>
          <hr></hr>
          <p className="card-text text-light ">{props.loadData.body}</p>
